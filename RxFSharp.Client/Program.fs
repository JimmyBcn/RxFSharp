...
module Main = 
    ...
    let main argv = 
        ...
        // ** Subjects samples
        //Console.WriteLine("** Subject Sequence **")
        //SampleSubject.Execute |> ignore

        //Console.WriteLine("** Subject Sequence (broadcasting) **")
        //SampleSubjectBroadcast.Execute |> ignore

        Console.WriteLine("** ReplaySubject Sequence (broadcasting) **")
        SampleReplaySubject.Execute |> ignore
